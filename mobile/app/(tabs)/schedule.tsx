...
const styles = StyleSheet.create({
  ...
  cardMeta: { fontSize: typography.small, color: palette.muted },
  ...
  planCardInfo: { flex: 1 },
  planMedName: { fontSize: typography.body, fontWeight: '700', color: palette.ink },
  planDose: { fontSize: typography.small, color: palette.primary, fontWeight: '600' },
  planInstruction: { fontSize: typography.small, color: palette.muted, marginTop: 2 },
  planStatusBadge: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 4,
